    ...
    <div className="min-h-screen bg-slate-100 font-sans p-6 text-slate-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg p-5 border border-slate-200 shadow-xs flex items-center justify-between">
          ...
          <div className="w-12 h-12 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-600 text-xl font-bold">
            📚
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-5 border border-slate-200 shadow-xs flex items-center justify-between">
          ...
          <div className="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center text-purple-600 text-xl font-bold">
            👨‍🎓
          </div>
        </div>
      ...
      {/* Super Admin Q&A Management Section */}
