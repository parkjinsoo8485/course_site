...
const startTag = '    /* ==================== 매뉴얼 & FAQ (전체 사이트 톤앤매너 완벽 동기화) ==================== */';
...
const restoredFontSiteAlignedCss = `    /* ==================== 매뉴얼 & FAQ (전체 사이트 톤앤매너 완벽 동기화) ==================== */
    ...
    /* 4. 수강신청 운영 절차 (1~23번) 본문 텍스트 복원 (1.18rem) 및 순번 뱃지 (28px) */
    ...
    /* 5. 양식 다운로드 및 매뉴얼 다운로드 본문 텍스트 복원 (1.20rem) */
    ...
    /* 6. FAQ 카테고리별 개별 카드 박스 본문 텍스트 복원 (1.15rem) */
...
content = content.substring(0, startIdx) + restoredFontSiteAlignedCss + content.substring(endIdx);
fs.writeFileSync(indexPath, content, 'utf8');
console.log('Successfully restored large font sizes while keeping site-aligned theme');
