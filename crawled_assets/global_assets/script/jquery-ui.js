...
$.extend(Datepicker.prototype, {
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !changeMonth) {
			...
			monthHtml += "<span><select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'></span>";
		...
		if ( !inst.yearshtml ) {
			...
			if (secondary || !changeYear) {
				...
				inst.yearshtml += "<span><select class='ui-datepicker-year' data-handler='selectYear' data-event='change'></span>";
